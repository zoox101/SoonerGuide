external_building_directions = {'adams_center': 'Walk past Crossroads and out the southern exit. Make your way to the south oval and keep walking directly due south, even past Lindsey street, until you come across three X shaped buildings. Adams Center is on the first floor of the right most building you'll see.',
